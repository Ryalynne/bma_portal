...
export default () => {
  ...
  if (document.querySelectorAll('#admin-chart-2').length) {
    ...
    // ghfg
    const chart = new ApexCharts(document.querySelector('#admin-chart-9'), options)
    chart.render()
  ...
  if (document.querySelectorAll('#admin-chart-9').length) {
    let data = []
    const options = {
      series: [{
        name: 'Food',
  ...
  if (document.querySelectorAll('#admin-chart-8').length) {
    ...
    const chart = new ApexCharts(document.querySelector('#admin-chart-8'), options)
    chart.render()
  }
}
