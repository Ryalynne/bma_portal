 ...
 'use strict'
    ...
    */
    ...
    function buildTimeGridSegCompareObj(seg) {
        const obj = core.buildSegCompareObj(seg)
    ...
    const TimeGrid = /** @class */ (function (_super) {
        ...
        function TimeGrid(context, el, renderProps) {
            ...
            const renderColumns = _this.renderColumns = core.memoizeRendering(_this._renderColumns, _this._unrenderColumns)
        ...
        TimeGrid.prototype.renderSlatRowHtml = function (dateProfile) {
            ...
            let html = ''
            const dayStart = core.startOfDay(dateProfile.renderRange.start)
            let slotTime = dateProfile.minTime
            let slotIterator = core.createDuration(0)
        ...
        TimeGrid.prototype._renderColumns = function (cells, dateProfile) {
            ...
            const bgRow = new daygrid.DayBgRow(this.context)
        ...
        TimeGrid.prototype.renderNowIndicator = function (segs, date) {
            ...
            for (i = 0; i < segs.length; i++) {
                const lineEl = core.createElement('div', { className: 'fc-now-indicator fc-now-indicator-line' })
            ...
            if (segs.length > 0) { // is the current time in view?
                const arrowEl = core.createElement('div', { className: 'fc-now-indicator fc-now-indicator-arrow' })
        ...
        TimeGrid.prototype.computeTimeTop = function (duration) {
            ...
            let slatCoverage = (duration.milliseconds - core.asRoughMs(dateProfile.minTime)) / core.asRoughMs(this.slotDuration) // floating-point value of # of slots covered
            let slatIndex
            let slatRemainder
        ...
        TimeGrid.prototype.positionToHit = function (positionLeft, positionTop) {
            ...
            if (colIndex != null && slatIndex != null) {
                ...
                const time = core.addDurations(this.props.dateProfile.minTime, core.multiplyDuration(this.snapDuration, snapIndex))
    ...
    const WEEK_HEADER_FORMAT = core.createFormatter({ week: 'short' })
    ...
    const TimeGridView = /** @class */ (function (_super) {
        ...
        function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            _this.renderHeadIntroHtml = function () {
                ...
                const dayCnt = core.diffDays(range.start, range.end)
                let weekText
            ...
            const timeGridEl = core.createElement('div', { className: 'fc-time-grid' })
        ...
        TimeGridView.prototype.updateBaseSize = function (isResize, viewHeight, isAuto) {
            ...
            const noScrollRowEls = core.findElements(this.el, '.fc-row').filter(function (node) {
    ...
    var TimeGridSlicer = /** @class */ (function (_super) {
        ...
        TimeGridSlicer.prototype.sliceRange = function (range, dayRanges) {
            ...
            for (let col = 0; col < dayRanges.length; col++) {
                const segRange = core.intersectRanges(range, dayRanges[col])
                if (segRange) {
                    segs.push({
