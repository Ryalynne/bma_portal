...
? define(['exports', 'moment', '@fullcalendar/core'], factory)
 ...
 'use strict'
    ...
    function formatWithCmdStr(cmdStr, arg) {
        ...
        if (arg.end) {
            const startMom = convertToMoment(arg.start.array, arg.timeZone, arg.start.timeZoneOffset, arg.localeCodes[0])
            const endMom = convertToMoment(arg.end.array, arg.timeZone, arg.end.timeZoneOffset, arg.localeCodes[0])
