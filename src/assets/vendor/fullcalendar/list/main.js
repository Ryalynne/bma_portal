    ...
    */
    const ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.renderSegList = function (allSegs) {
            ...
            let daySegs
            let i
            const tableEl = core.htmlToElement('<table class="fc-list-table ' + this.calendar.theme.getClass('tableList') + '"><tbody></tbody></table>')
        ...
        ListView.prototype.buildDayHeaderRow = function (dayDate) {
            ...
            const mainFormat = core.createFormatter(this.opt('listDayFormat')) // TODO: cache
            const altFormat = core.createFormatter(this.opt('listDayAltFormat')) // TODO: cache
    ...
    function computeDateVars(dateProfile) {
        let dayStart = core.startOfDay(dateProfile.renderRange.start)
