...
const DateClicking = /** @class */ (function (_super) {
    ...
    function DateClicking(settings) {
        ...
        const hitDragging = _this.hitDragging = new HitDragging(_this.dragging, interactionSettingsToStore(settings))
    ...
    function EventDragging(settings) {
        ...
        _this.handleDragEnd = function (ev) {
            if (_this.isDragging) {
                ...
                const eventApi = new EventApi(initialCalendar_1, eventDef, eventInstance)
...
view: initialView
        ...
        dragging.touchScrollAllowed = false
        dragging.autoScroller.isEnabled = component.opt('dragScroll')
        const hitDragging = _this.hitDragging = new HitDragging(_this.dragging, interactionSettingsStore)
...
function computeEventMutation(hit0, hit1, massagers) {
    ...
    const delta = diffDates(date0, date1, hit0.component.dateEnv, hit0.component === hit1.component
...
const EventDragging$1 = /** @class */ (function (_super) {
    ...
    function EventDragging(settings) {
        ...
        _this.handleDragEnd = function (ev) {
            ...
            const eventDef = _this.eventRange.def
            const eventInstance = _this.eventRange.instance
            const eventApi = new EventApi(calendar, eventDef, eventInstance)
            const relevantEvents = _this.relevantEvents
            const mutatedRelevantEvents = _this.mutatedRelevantEvents
...
function computeEventForDateSpan(dateSpan, dragMeta, calendar) {
    ...
    const def = parseEventDef(defProps, dragMeta.sourceId, dateSpan.allDay, calendar.opt('forceEventDuration') || Boolean(dragMeta.duration), // hasEnd
    calendar)
